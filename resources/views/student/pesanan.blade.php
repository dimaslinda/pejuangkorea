        ...
        <div class="container max-w-screen-xl px-4 py-8 mx-auto">
            ...
            <div class="flex flex-col lg:min-h-screen md:flex-row">
                <div class="flex flex-col w-full h-full md:w-1/2 xl:w-1/3">
                    ...
                    <a href="/pesanan"
                        class="flex flex-row gap-2 border-[#4F4F4F] px-4 py-2 font-bold border-b-2 group text-white bg-primary">
                        <div>
                        ...
                        <div
                            ...
                            <div class="flex flex-col p-5 lg:w-1/2">
                                ...
                                <div class="flex flex-col items-center justify-between gap-2 mt-5 text-center lg:flex-row">
                                    <div>
                                        Status : <span class="font-bold text-primary">Pembayaran Berhasil</span>
                                    </div>
                                    <a href="#"
