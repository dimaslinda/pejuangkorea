        ...
        <div class="w-full p-10 space-y-6 bg-white border-2 rounded-lg shadow-2xl md:p-20 md:max-w-xl drop-shadow-2xl">
            ...
            <form action="" method="POST">
                ...
                <div class="flex-col justify-center mt-10 text-center">
                    <button type="submit"
                        class="w-1/2 px-4 py-2 text-sm font-medium text-white uppercase rounded-md bg-primary hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50">Daftar</button>
                    <div class="mt-2">
                        Sudah memiliki Akun? <a href="/login" class="underline text-primary underline-offset-4">Masuk</a>
                    </div>
                </div>
            </form>
        </div>
